      ...
      <div className='flex flex-col justify-center px-4 py-12 sm:px-6 lg:flex-none lg:px-20 xl:px-24 w-full lg:w-1/2'>
        <div className='mx-auto w-full max-w-sm lg:max-w-md'>
          ...
          <div>
            ...
            {success && (
              <div className='mt-4 p-4 bg-green-50 border-l-4 border-green-500 text-green-700 rounded-md text-sm'>
                Login successful! Redirecting to dashboard...
              </div>
            )}

            {isRegistered && (
              <div className='mt-4 p-4 bg-blue-50 border-l-4 border-blue-500 text-blue-700 rounded-md text-sm'>
